...
dt = 15;
[hexapod,xyz,aby,vel,angV] = init_states(vrep,clientID, sim_len*dt);
...
if (clientID>-1)
    ...
    for iteration = 1:10
        ...
        angles(1,2,(iteration-1)*6+2:end) = -angle2;
        angles(1,3,(iteration-1)*6+2:end) = -angle2;
        angles(3,2,(iteration-1)*6+2:end) = -angle2;
        angles(3,3,(iteration-1)*6+2:end) = -angle2;
        angles(5,2,(iteration-1)*6+2:end) = -angle2;
        angles(5,3,(iteration-1)*6+2:end) = -angle2;
        
        angles(1,1,(iteration-1)*6+3:end) = -angle1;
        angles(3,1,(iteration-1)*6+3:end) = -angle1;
        angles(5,1,(iteration-1)*6+3:end) = -angle1;
        angles(2,1,(iteration-1)*6+3:end) = angle1;
        angles(4,1,(iteration-1)*6+3:end) = angle1;
        angles(6,1,(iteration-1)*6+3:end) = angle1;
        
        angles(1,2,(iteration-1)*6+4:end) = 0;
        angles(1,3,(iteration-1)*6+4:end) = 0;
        angles(3,2,(iteration-1)*6+4:end) = 0;
        angles(3,3,(iteration-1)*6+4:end) = 0;
        angles(5,2,(iteration-1)*6+4:end) = 0;
        angles(5,3,(iteration-1)*6+4:end) = 0;
        
        angles(2,2,(iteration-1)*6+5:end) = -angle2;
        angles(2,3,(iteration-1)*6+5:end) = -angle2;
        angles(4,2,(iteration-1)*6+5:end) = -angle2;
        angles(4,3,(iteration-1)*6+5:end) = -angle2;
        angles(6,2,(iteration-1)*6+5:end) = -angle2;
        angles(6,3,(iteration-1)*6+5:end) = -angle2;
        
        angles(1,1,(iteration-1)*6+6:end) = angle1;
        angles(3,1,(iteration-1)*6+6:end) = angle1;
        angles(5,1,(iteration-1)*6+6:end) = angle1;
        angles(2,1,(iteration-1)*6+6:end) = -angle1;
        angles(4,1,(iteration-1)*6+6:end) = -angle1;
        angles(6,1,(iteration-1)*6+6:end) = -angle1;
        
        angles(2,2,(iteration-1)*6+7:end) = 0;
        angles(2,3,(iteration-1)*6+7:end) = 0;
        angles(4,2,(iteration-1)*6+7:end) = 0;
        angles(4,3,(iteration-1)*6+7:end) = 0;
        angles(6,2,(iteration-1)*6+7:end) = 0;
        angles(6,3,(iteration-1)*6+7:end) = 0;
    end
        angles(1,1,sim_len) = 0;
        angles(3,1,sim_len) = 0;
        angles(5,1,sim_len) = 0;
        angles(2,1,sim_len) = 0;
        angles(4,1,sim_len) = 0;
        angles(6,1,sim_len) = 0;
    ...
    for step = 1:sim_len
        ...
        for t = t+1:t+dt
            vrep.simxSynchronousTrigger(clientID);
            [xyz(t,:),aby(t,:),vel(t,:),angV(t,:)] = get_states(vrep,clientID,hexapod);
        end
    end
